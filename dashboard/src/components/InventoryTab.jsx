...
import { getIngredients, createIngredient, updateStock } from '../services/inventoryApi';
    ...
    <div style={s.panel}>
      ...
      {loading ? (
        ...
        <table style={s.table}>
          <thead>
            <tr>
              <th style={s.th}>ID</th><th style={s.th}>Nama</th><th style={s.th}>Satuan</th>
              <th style={s.th}>Stok</th><th style={s.th}>Terakhir Update</th><th style={s.th}>Aksi</th>
            </tr>
          </thead>
          <tbody>
            {ingredients.map((ing) => (
